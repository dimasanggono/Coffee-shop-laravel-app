        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button class="btn btn-md btn-primary shadow" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus" aria-hidden="true"></i> Add</button>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{route('categories.edit', $category->id)}}" class="btn btn-md btn-warning mb-1"><i class="fa fa-pencil-alt" aria-hidden="true"></i></a>
